...
public class GremlinEntityInformationUnitTest {
    ...
    public void testVertexEntityInformation() {
        ...
        assertNotNull(personInfo.getIdField());
        assertEquals(personInfo.getId(person), TestConstants.VERTEX_PERSON_ID);
        assertEquals(personInfo.getIdType(), String.class);
        assertTrue(personInfo.createGremlinSource() instanceof GremlinSourceVertex);
    }
    ...
    public void testEdgeEntityInformation() {
        ...
        assertNotNull(relationshipInfo.getIdField());
        assertTrue(relationshipInfo.createGremlinSource() instanceof GremlinSourceEdge);
    }
    ...
    public void testGraphEntityInformation() {
        ...
        assertNotNull(networkInfo.getIdField());
        assertTrue(networkInfo.createGremlinSource() instanceof GremlinSourceGraph);
    }

        @Test
    public void testEntityInformationException() {
        assertThrows(GremlinUnexpectedEntityTypeException.class, () -> new GremlinEntityInformation<TestDomain, String>(TestDomain.class).createGremlinSource());
    }

        @Test
    public void testEntityInformationNoIdException() {
        assertThrows(GremlinInvalidEntityIdFieldException.class, () -> new GremlinEntityInformation<TestNoIdDomain, String>(TestNoIdDomain.class));
    }

        @Test
    public void testEntityInformationMultipleIdException() {
        assertThrows(GremlinInvalidEntityIdFieldException.class, () -> new GremlinEntityInformation<TestMultipleIdDomain, String>(TestMultipleIdDomain.class));
    }

        @Test
    public void testEntityInformationNoStringIdException() {
        assertThrows(GremlinInvalidEntityIdFieldException.class, () -> new GremlinEntityInformation<TestNoStringIdDomain, String>(TestNoStringIdDomain.class));
    }

        @Test
    public void testEntityInformationIdFieldAndIdAnnotation() {
        assertThrows(GremlinInvalidEntityIdFieldException.class, () -> new GremlinEntityInformation<TestIdFieldAndIdAnnotation, String>(TestIdFieldAndIdAnnotation.class));
    }
