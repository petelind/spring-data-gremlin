...
public class BasicGremlinPersistentPropertyUnitTest {
    ...
    public void testVertexPersistentProperty() {
        ...
        assertEquals(property.getName(), TestConstants.PROPERTY_ID);
        assertTrue(property.isIdProperty());
        assertNotNull(property.createAssociation());
        ...
        assertEquals(property.getName(), TestConstants.PROPERTY_NAME);
        assertFalse(property.isIdProperty());
        assertNotNull(property.createAssociation());
    }
    ...
    public void testEdgePersistentProperty() {
        ...
        assertEquals(property.getName(), TestConstants.PROPERTY_LOCATION);
        assertFalse(property.isIdProperty());
        assertNotNull(property.createAssociation());
    }
