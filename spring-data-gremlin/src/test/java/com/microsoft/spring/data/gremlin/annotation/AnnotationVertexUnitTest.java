...
public class AnnotationVertexUnitTest {
    ...
    public void testAnnotationVertexDefaultLabel() {
        ...
        assertTrue(source instanceof GremlinSourceVertex);
        assertNotNull(source.getLabel());
        assertEquals(source.getLabel(), Library.class.getSimpleName());
    }
    ...
    public void testAnnotationVertexSpecifiedLabel() {
        ...
        assertTrue(source instanceof GremlinSourceVertex);
        assertNotNull(source.getLabel());
        assertEquals(source.getLabel(), TestConstants.VERTEX_PERSON_LABEL);
    }
}
